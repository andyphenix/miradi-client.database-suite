/*
   ...
   Developed by David Berg 
   for The Nature Conservancy and the Greater Conservation Community.
*/
...
SELECT * FROM v_TargetKEA ORDER BY ProjectSummaryID DESC, TargetXID, KEAXID;
...
SELECT * FROM v_BiodiversityTargetKEA ORDER BY ProjectSummaryID DESC, BiodiversityTargetXID, KEAXID;
...
SELECT * FROM v_HumanWelfareTargetKEA ORDER BY ProjectSummaryID DESC, HumanWelfareTargetXID, KEAXID;
...
SELECT * FROM v_KEAIndicator ORDER BY ProjectSummaryID DESC, KEAXID, IndicatorXID;
...
SELECT * FROM v_IndicatorMeasurement ORDER BY ProjectSummaryID DESC, IndicatorXID, MeasurementXID;
